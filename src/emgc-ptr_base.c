...
void *gc_ptr_base(void *ptr)
{
  ...
  // This is intentionally a O(n) scan over the whole managed alloc table for now.
  // TODO: Rewrite this to utilize an allocation range interval tree for performance.
  GC_MALLOC_ACQUIRE();
